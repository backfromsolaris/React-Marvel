...
// Create a component inside of this ts file and use it later on
    ...
    return (
        <div>
            <Container maxWidth = 'sm' className={classes.containerStyle}>
                ...
                <Button type='submit' variant='contained' color='inherit' onClick={handleSnackClose}>Return Home</Button>
                <AuthCheck fallback={
